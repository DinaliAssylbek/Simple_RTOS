...
This is a tiny Real-Time Operating System written for the STM32F103 microcontroller. The work is heavily inspired by the book [Real-Time Operating Systems
...
(Describe the archeticeture of this OS)

(Describe concepts of the book)

(Post picture of logic analyzer)
